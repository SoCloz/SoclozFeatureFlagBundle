            ...
            ->children()
                ->arrayNode('services')->addDefaultsIfNotSet()
                    ->children()
                        ...
                        ->scalarNode('state')->defaultValue(array('socloz_feature_flag.state.request', 'socloz_feature_flag.state.session'))->end()
                    ->end()
                ->end()
                ->arrayNode('options')->addDefaultsIfNotSet()
                    ->children()
                        ...
                        ->arrayNode('google_analytics')->addDefaultsIfNotSet()
                            ->children()
                                ->scalarNode('variableId')->defaultValue(1)->end()
                                ->scalarNode('variableName')->defaultValue("socloz_feature_flag_variation")->end()
                            ->end()
                        ->end()
                    ->end()
                ->end()
